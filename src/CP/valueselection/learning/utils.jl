...
function action_to_value(vs::LearnedHeuristic{SR, R, FixedOutput}, action::Int64, state::AbstractTrajectoryState, model::CPModel) where {SR <: ColoringStateRepresentation, R}
    return vs.action_space[action]
end
